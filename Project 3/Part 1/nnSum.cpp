...
#define TestCriteria 0.03     // all testing outputs must be within this for generalization
...
#define NumNodes3    30       // output layer is last non-zero layer, and must equal NumOUTs
#define NumNodes4    40       // note - last node in input and hidden layers will be used as bias
#define NumNodes5    2       // note - there is no bias node in the output layer
#define NumNodes6    0
...
#define NumOfRows    40      // largest layer - i.e., max number of rows in the network

// data files -----------------------------------------------
#define TrainFile    "p1Train.dat"  // file containing training data
#define TestFile     "p1Test.dat"  // file containing testing data 
#define TrainCases   26           // number of training cases
